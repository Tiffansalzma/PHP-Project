...
$menuName = $_GET['name'];
$menu = Menu::findbyNameMenu( $menus, $menuName );
    ...
    <body>
        <div class="review-wrapper">
            <div class="review-menu-item">
                ...
                <h3 class="menu-item-name"><?php echo $menu->getNameMenu() ?></h3>
                ...
                <?php else: ?>
                    ...
                    <?php endfor?>
                <?php endif ?>
                <p class="price">$<?php echo $menu->getTaxIncludePrice() ?></p>
            </div>
